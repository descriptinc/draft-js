...
const decodeBlockNodeConfig = (block: RawDraftContentBlock, entityMap: unknown): BlockNodeConfig => {
...
const decodeCharacterList = (block: RawDraftContentBlock, entityMap: unknown): List<CharacterMetadata> => {
  const {
    text,
 ...
 */
const updateNodeStack = (stack: Array<unknown>, nodes: Array<unknown>, parentRef: ContentBlockNode): Array<unknown> => {
 ...
 */
const decodeContentBlockNodes = (blocks: Array<RawDraftContentBlock>, entityMap: unknown): BlockMap => {
  return blocks
...
const decodeContentBlocks = (blocks: Array<RawDraftContentBlock>, entityMap: unknown): BlockMap => {
  return OrderedMap(
...
const decodeRawBlocks = (rawState: RawDraftContentState, entityMap: unknown): BlockMap => {
...
const decodeRawEntityMap = (rawState: RawDraftContentState): unknown => {
