...
class ContentBlocksBuilder {
  ...
  disambiguate: ((arg0: string, arg1: string | null) => string | null);
   ...
   */
  addDOMNode function(node: Node): ContentBlocksBuilder {
    this.contentBlocks = [];
    this.currentDepth = 0;
   ...
   */
  _makeBlockConfig function(config: Object = {}): ContentBlockConfig {
  ...
  _hoistContainersInBlockConfigs function(blockConfigs: Array<ContentBlockConfig>): List<ContentBlockConfig> {
   ...
   */
  _extractTextFromBlockConfigs function(blockConfigs: Array<ContentBlockConfig>): {
    text: string,
    characterList: List<CharacterMetadata>
  } {
    const l = blockConfigs.length - 1;
